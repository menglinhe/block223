...
public class Admin extends UserRole implements Serializable
{
  ...
  public Game addGame(boolean aPublished, String aName, int aNrBlocksPerLevel, HallOfFame aHallOfFame, Ball aBall, Paddle aPaddle, Block223 aBlock223)
  {
    return new Game(aPublished, aName, aNrBlocksPerLevel, aHallOfFame, this, aBall, aPaddle, aBlock223);
  }
